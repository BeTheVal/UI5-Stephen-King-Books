		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#bethevaldevui5skbooks-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bethevaldevui5skbooks-display": {
								"semanticObject": "bethevaldevui5skbooks",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=betheval.dev.ui5skbooks",
									"url": sap.ui.require.toUrl("betheval/dev/ui5skbooks")
								}
							}
						}
					}
